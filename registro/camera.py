...
class VideoCamera(object):
    def __init__(self):
        ...
        if self.face_cascade.empty():
            raise IOError("Erro ao carregar o arquivo Haar Cascade XML. Certifique-se de que o arquivo está no caminho correto.")
    ...
    def detect_face(self):
        ...
        for (x, y, w, h) in faces:
            if x1 < x < x2 and y1 < y < y2:  # Verifica se a face está dentro da ROI
